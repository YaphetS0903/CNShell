...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::automation_run_list,
            commands::automation_run_clear,
            ...
            commands::team_terminal_invitation_accept,
            commands::team_terminal_output_publish,
            commands::team_terminal_output_encrypt,
            commands::team_terminal_output_replay,
            commands::team_terminal_output_decrypt,
            commands::team_terminal_control_grant,
            commands::team_terminal_control_input,
            commands::team_terminal_control_input_encrypt,
            commands::team_terminal_control_input_receive,
            commands::team_terminal_control_revoke,
            commands::team_terminal_room_status,
            commands::team_terminal_client_status,
            commands::team_terminal_client_close,

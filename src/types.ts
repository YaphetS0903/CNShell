...
export type SessionStatus =
  "connecting" | "online" | "reconnecting" | "failed" | "closed";
...
export type BackgroundTask = Omit<GeneratedBackgroundTask, "status"> & {
  status: BackgroundTaskStatus;
};

export type ConnectionProfile = Omit<
  GeneratedConnectionProfile,
  "protocol" | "authType" | "hostKeyPolicy"
> & {
  protocol: Protocol;
  authType: AuthType;
...
export type ProxyProfile = Omit<GeneratedProxyProfile, "type"> & {
  type: ProxyType;
};
export type SaveProxyInput = Omit<GeneratedSaveProxyInput, "type"> & {
  type: ProxyType;
};
...
export type RdpConnectionOptions = Omit<
  GeneratedRdpConnectionOptions,
  "displayMode" | "scaleMode" | "quality" | "audioMode"
> & {
...
export type ConnectionDiagnostic = Omit<
  GeneratedConnectionDiagnostic,
  "stage"
> & {
  stage:
    | "dns"
...
export type TerminalSession = Omit<
  GeneratedTerminalSession,
  "status" | "sessionType"
> & {
  status: SessionStatus;
  sessionType: "terminal" | "mosh" | "rdp" | "local" | "telnet" | "serial";
};
export type TerminalStatus = Omit<GeneratedTerminalStatus, "status"> & {
  status: SessionStatus;
};
export type RemoteFile = Omit<GeneratedRemoteFile, "kind"> & {
  kind: "file" | "directory" | "symlink" | "other";
};
export type TransferTask = Omit<
  GeneratedTransferTask,
  "direction" | "status" | "conflictPolicy"
> & {
...
export type TransferInput = Omit<
  GeneratedTransferInput,
  "direction" | "conflictPolicy"
> & {
  direction: TransferDirection;
  conflictPolicy: ConflictPolicy;
};
export type ZmodemEvent = Omit<GeneratedZmodemEvent, "direction" | "status"> & {
  ...
  status:
    "awaitingAuthorization" | "running" | "completed" | "failed" | "cancelled";
};
...
export type TerminalPreferences = Omit<
  import("./generated/ipc").TerminalPreferences,
  "fontFamily" | "cursorStyle" | "colorScheme"
> & {
...
export type AppSettings = Omit<
  ...
  "theme" | "terminal" | "terminalOverrides"
> & {

...
export const api = {
  ...
  async enablePlugin(id:string):Promise<PluginInstallRecord>{return invoke("plugin_enable",{id});},
  async disablePlugin(id:string):Promise<void>{return invoke("plugin_disable",{id});},
  async runPlugin(id:string):Promise<PluginRunResult>{return invoke("plugin_run",{id});},

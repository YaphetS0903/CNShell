...
export const api = {
  ...
  async registerTeamRelayAccount(input:TeamRelayAccountInput):Promise<TeamRelayAccountRegistration>{return invoke("team_relay_account_register",{input});},
  ...
  async verifyTeamRelayAccountEmail(input:VerifyTeamRelayAccountInput):Promise<TeamRelayProfile>{return invoke("team_relay_account_verify_email",{input});},
  async resendTeamRelayAccountVerification(input:ResendTeamRelayVerificationInput):Promise<void>{return invoke("team_relay_account_resend_verification",{input});},

...
- [打开 CNshell v0.2.0-beta.11 预发布页](https://github.com/YaphetS0903/CNShell/releases/tag/v0.2.0-beta.11)
- [下载 macOS universal DMG](https://github.com/YaphetS0903/CNShell/releases/download/v0.2.0-beta.11/CNshell_0.2.0-beta.11_universal.dmg)
- [下载 Windows x64 Beta](https://github.com/YaphetS0903/CNShell/releases/download/v0.2.0-beta.11/CNshell_0.2.0-beta.11_x64-setup.exe)
- [下载 Windows ARM64 Preview](https://github.com/YaphetS0903/CNShell/releases/download/v0.2.0-beta.11/CNshell_0.2.0-beta.11_arm64-setup.exe)
- [下载 SHA256SUMS.txt](https://github.com/YaphetS0903/CNShell/releases/download/v0.2.0-beta.11/SHA256SUMS.txt)
...
1. 下载 `CNshell_0.2.0-beta.11_universal.dmg` 和 `SHA256SUMS.txt`，核对 SHA-256 后打开 DMG。

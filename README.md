...
- Windows x64/ARM64 功能与打包链已经实现，`v0.2.0-beta.1` 目标提交的 Core CI 与双架构 Windows Packaging 已通过；安装包尚未追加到 Release。正式 updater 签名和 Draft Release 完成前，不要从第三方下载未验证的 Windows 安装包。

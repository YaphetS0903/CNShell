...
在尚未取得 Apple Developer Program 付费会员和 Windows 代码签名服务时，使用 `.github/workflows/beta-release.yml` 发布 `v0.2.0-beta.3`。该流程不读取 Apple 证书、公证或 Authenticode 凭据，只需要仓库 Actions Secrets：

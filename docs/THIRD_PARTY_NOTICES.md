...
CNshell 随应用分发以下开源组件的目标代码。完整许可证文本位于应用包
`Contents/Resources/freerdp/licenses`、`Contents/Resources/mosh/licenses`、
`Contents/Resources/kermit/licenses` 与 `Contents/Resources/licenses` 目录。
